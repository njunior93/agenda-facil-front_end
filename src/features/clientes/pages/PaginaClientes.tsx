    ...
    return (
        <>
            <div className="w-full max-w-6xl mx-auto px-4">
                ...
                <section className="flex flex-row justify-center gap-3 p-2">
                    <div className="w-full max-w-5xl flex gap-3 items-stretch">
                        <Paper className="basis-2/3 flex-1" elevation={3} sx={{display: 'flex',flexDirection:'column',backgroundColor: '#F8F9FA'}}>
                        ...
                        <Paper className="basis-1/3 flex-1" elevation={3} sx={{display: 'flex', maxHeight: '450px',flexDirection: 'column', backgroundColor: '#F8F9FA' }}>
